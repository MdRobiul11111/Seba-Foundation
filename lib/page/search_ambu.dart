...
class SearchAmbu extends StatefulWidget {
  const SearchAmbu({super.key});

  @override
  State<SearchAmbu> createState() => _SearchAmbuState();
}

class _SearchAmbuState extends State<SearchAmbu> {
  // Location data
  ...
  Widget buildDropdown({
    ...
    return DropdownButtonFormField<String>(
      decoration: InputDecoration(
        contentPadding:
            EdgeInsets.symmetric(vertical: 18.5.h, horizontal: 15.w),
